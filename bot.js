...
if (!role) {
  member.addRole(member.guild.roles.get(otorol))
                        ...
                        .setColor('0x36393E')
                        .setFooter(`ExeBot Otorol Sistemi`)
...
// eklendim
client.on('guildCreate', async guild => { client.channels.get('764211346677694484').send(`${guild}, isimli sunucuya eklendim!`)})

// atıldım
client.on('guildDelete', async guild => { client.channels.get('764211346677694484').send(`${guild}, isimli sunucudan atıldım.. :(`)})
